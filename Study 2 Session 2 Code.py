"""
Created on Wed Aug 23 10:35:00 2023
...
folder_path = "C:\\Users\\cleed\\OneDrive\\Desktop\\Participant 1\\Session 2\\Pre\\TMS\\10\\Ecc"
...
mvc_folder_path = "C:\\Users\\cleed\\OneDrive\\Desktop\\Participant 1\\Session 2\\Pre\\Strength"
...
# a. Identify File Paths
folder_path = "C:\\Users\\cleed\\OneDrive\\Desktop\\Participant 1\\Session 2\\Post\\TMS\\10\\Ecc"
all_files = [os.path.join(folder_path, f) for f in os.listdir(folder_path) if os.path.isfile(os.path.join(folder_path, f))]
...
# a. Identify File Paths
folder_path = "C:\\Users\\cleed\\OneDrive\\Desktop\\Participant 1\\Session 2\\Post30\\TMS\\10\\Ecc"
all_files = [os.path.join(folder_path, f) for f in os.listdir(folder_path) if os.path.isfile(os.path.join(folder_path, f))]
...
participant_1_S2_output = pd.concat([agg_data_pre, agg_data_post, agg_data_post30, agg_data_post60], axis=1, keys=['Pre', 'Post', 'Post30', 'Post60'])
participant_1_S2_output.to_excel("Participant 1 S2 Output.xlsx")

print(participant_1_S2_output)